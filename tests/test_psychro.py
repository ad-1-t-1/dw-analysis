...
psychrometric table values at 101.325 kPa."""
import numpy as np
import pytest
...
def test_saturation_humidity_ratio_20C():
    ...
    W = psychro.humidity_ratio(20.0, 100.0)
...
def test_saturation_humidity_ratio_25C():
    ...
    W = psychro.humidity_ratio(25.0, 100.0)
...
def test_state_25C_50RH():
    ...
    assert psychro.humidity_ratio(25.0, 50.0) == pytest.approx(0.00992, rel=0.01)
    assert psychro.enthalpy(25.0, 50.0) / 1000 == pytest.approx(50.4, rel=0.01)
    assert psychro.dew_point(25.0, 50.0) == pytest.approx(13.9, abs=0.15)
    assert psychro.wet_bulb(25.0, 50.0) == pytest.approx(17.9, abs=0.15)


def test_specific_volume_dry_air_20C():
    # v_da at 20 °C, 0 % RH ≈ R_a·T/p = 287.042·293.15/101325 = 0.8304 m³/kg
    v = psychro.specific_volume_da(20.0, 0.0)
